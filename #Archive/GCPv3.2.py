...
class ImagePatternMatcher:
    def __init__(self, master):
        ...
        # Label for the green checkmark next to the "Select Target Image" button
        self.checkmark_label = Label(master)
        self.checkmark_label.pack(side="left", padx=5)
    ...
    def process_images(self):
        ...
        for scale in np.linspace(0.4, 2.0, 20):  # Test different scales from 50% to 200%

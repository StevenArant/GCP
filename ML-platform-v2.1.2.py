...
def ensure_model_created():
    ...
    if model is None:
        ...
        if os.path.exists('checkerboard_model.h5'):
            print("Loading existing model from disk.")
            model = tf.keras.models.load_model('checkerboard_model.h5')
...
def train_model():
    ...
    try:
        ...
        model.save('checkerboard_model.h5')  # Save the entire model structure and weights
